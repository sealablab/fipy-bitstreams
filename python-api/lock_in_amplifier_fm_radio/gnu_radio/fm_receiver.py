...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate = samp_rate = 1.25e5
        self.center_freq = center_freq = 105.9e6
        ...
        self.difi_source_cpp_0 = difi.difi_source_cpp_fc32('127.0.0.1', 1234, 2, 0, int(16), int(0))
        ...
        self.connect((self.difi_source_cpp_0, 0), (self.blocks_probe_rate_0, 0))
        self.connect((self.difi_source_cpp_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.difi_source_cpp_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.difi_source_cpp_0, 0), (self.rational_resampler_xxx_0, 0))
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq, self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.center_freq, 48e3)
